...
def shell(environment, command=None):
    ...
    .. note:
        ...
        Cmder encounters issues when running winpty
        (https://github.com/rprichard/winpty/issues/70). If you have set up
        aliases to launch programs through winpty, exclude them for 'cygwin' in
        your .bashrc, like::
